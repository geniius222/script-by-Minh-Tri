...
local v15 = v14:CreateWindow({
    Title = "Minh Trí [ Premium ]",-- thay tên bạn muốn đặt
    SubTitle = "Minh Trí",-- tên bạn
    TabWidth = 160,
    Theme = "Dark",--màu
    Acrylic = false,
...
-- ================== KEY SYSTEM ==================
_G.Premium = false
local CorrectKey = "BEBIPRE-ADH7721"
local InputKey = ""

local KeyTab = v15:AddTab({
    Title = "🔑 Key System"
})

KeyTab:AddInput("KeyInput", {
    Title = "Nhập Key",
    Placeholder = "BEBIPRE-XXXXXXX",
    Numeric = false,
    Finished = false,
...
KeyTab:AddButton({
    ...
    Callback = function()
        if InputKey == CorrectKey then
            ...
            v15:Notify({
                Title = "✅ Thành công",
                Content = "Key hợp lệ - Đã mở Premium",
                Duration = 5
            })
        else
            v15:Notify({
...
spawn(function()
    ...
    local snowImage = "rbxassetid://8154439846" -- bông tuyết (ổn định)
